...
## 🚨 주의사항
- **Pretendard 폰트 설치 권장**  
  프로젝트에 포함된 `Pretendard.otf` 파일을 설치하면 UI 가 최적화 되어 보입니다.
  따로 코드 내부 Pretendard.otf 부분을 수정하여 원하는 폰트로 수정할 수 있습니다.
- **가상 MIDI 포트 필요**  
  실제 MIDI 장비가 없다면, `LoopMIDI`와 같은 가상 MIDI 케이블 프로그램을 미리 설치하셔야 합니다.
